...
def positions_for_wire(wire_path):
    positions = {}
    steps = wire_path.split(',')
    current_x, current_y, from_start = 0,0,0
    for step in steps:
